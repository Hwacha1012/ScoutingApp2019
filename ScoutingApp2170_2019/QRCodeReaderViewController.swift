...
class QRCodeReaderViewController: UIViewController {
    ...
    func returnToMainMenu(){
        ...
        teamNum = "\(arraySeperatedByCommas[0]); \(arraySeperatedByCommas[1])"
        
        print(arraySeperatedByCommas.count)
      /*  if arraySeperatedByCommas.count == 26{
            UserDefaults.standard.set(dataToAdd, forKey: "\(teamNum)")
            print("in here")
            if teamNum != ""{
                print("here")
        ...
        else if arraySeperatedByCommas.count == 7{
            var tempArray = arraySeperatedByCommas[0].components(separatedBy: "///")
            pSteamNum = "\(tempArray[1]); Pit Scouting"
            UserDefaults.standard.set(dataToAdd, forKey: "\(pSteamNum)")
            print("in here")
            if pSteamNum != ""{
                print("here")
                if UserDefaults.standard.array(forKey: "teamList") == nil{
        ...
        else if arraySeperatedByCommas.count == 11{
            var tempArray = arraySeperatedByCommas[0].components(separatedBy: "'''")
            teamNum = "\(tempArray[1]); "
            UserDefaults.standard.set(dataToAdd, forKey: "\(pSteamNum)")
            print("in here")
